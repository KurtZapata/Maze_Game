...
function useitem() {
  if (select === 0) {
    ...
    if (items[3] !== 0) {
      if (currentCell === "cell58") {
        items[3]--;
        alert("you have unlocked the door");
      }
      else if (currentCell === "cell403" || currentCell === "cell574" || currentCell === "cell831" )
        {
          alert("this is not the correct key");
        }
      else {
        alert("Find a door first");
      }
    }
    else {
      alert("You don't have the item");
    ...
    if (items[4] !== 0) {
      if (currentCell === "cell403") {
        items[4]--;
        alert("you have unlocked the door");
      }
      else if (currentCell === "cell58" || currentCell === "cell574" || currentCell === "cell831" )
        {
          alert("this is not the correct key");
        }
      else {
    ...
    if (items[5] !== 0) {
      if (currentCell === "cell574") {
        items[5]--;
        alert("you have unlocked the door");
      }
      else if (currentCell === "cell403" || currentCell === "cell58" || currentCell === "cell831" )
        {
          alert("this is not the correct key");
        }
      else {
    ...
    if (items[6] !== 0) {
      if (currentCell === "cell831") {
        items[6]--;
        alert("you have unlocked the door");
      }
      else if (currentCell === "cell403" || currentCell === "cell574" || currentCell === "cell58" )
        {
          alert("this is not the correct key");
        }
      else {
